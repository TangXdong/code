...
{                                                                      
  ...
  MLOG("bounce_send_init used time is : %f s\n",timeuse/1000000);
  gettimeofday(&tpstart,NULL);
  ...
  gettimeofday(&tpend,NULL);
  timeuse =1000000*(tpend.tv_sec - tpstart.tv_sec)+(tpend.tv_usec-tpstart.tv_usec);
  MLOG("bounce_communicate used time is : %f s\n",timeuse/1000000);
  gettimeofday(&tpstart,NULL);
	for(i = 0; i < count; i++) {
  ...
  gettimeofday(&tpend,NULL);
  timeuse =1000000*(tpend.tv_sec - tpstart.tv_sec)+(tpend.tv_usec-tpstart.tv_usec);
  MLOG("bounce_update used time is : %f s\n",timeuse/1000000);
  gettimeofday(&tpstart,NULL);
	stream(nodes, walls, flags, Xst, Xed, Yst, Yed, Z, current, other);

  gettimeofday(&tpend,NULL);
  timeuse =1000000*(tpend.tv_sec - tpstart.tv_sec)+(tpend.tv_usec-tpstart.tv_usec);
  printf("Stream part used time is : %f s\n",timeuse/1000000);
 // gettimeofday(&tpstart,NULL);
//	collide(nodes, flags, Xst, Xed, Yst, Yed, Z, current);

 // gettimeofday(&tpend,NULL);
  //timeuse =1000000*(tpend.tv_sec - tpstart.tv_sec)+(tpend.tv_usec-tpstart.tv_usec);
//  printf("Collide part used time is : %f s\n",timeuse/1000000);
	other = current;
	current = (current+1)%2;
  ...
  timeuse =1000000*(tp2.tv_sec - tp1.tv_sec)+(tp2.tv_usec-tp1.tv_usec);
  MLOG("TIME used time is : %f s\n",timeuse/1000000);
